...
GLuint DL;   //Display List Variable for Car
GLuint wall; //Display List variables for brick wall
GLuint road; //Display List variables for Road 
...
const char *WINDOWTITLE = { "OpenGL / GLUT Sample -- Kedar Dhere" };
...
float Light_Position[3] = { 4.*Time, 0., 0. };
float White[3] = { 1., 1., 1. };
...
Display( )
{
	...
	gluLookAt( (80*Time) -100., 8., 50.,     0., 0., 0.,     0., 1., 0. );
	...
	/*Start of Changes for Point Light*/
	glLightModelfv(GL_LIGHT_MODEL_AMBIENT, MulArray3(.5f, White));
	glLightModeli(GL_LIGHT_MODEL_TWO_SIDE, GL_TRUE);
	/*End of Changes for Point Light*/

	// draw the current object:
	/*
	glPushMatrix();
		SetPointLight(GL_LIGHT0, -100., 100.0, 0.0, 1., 1., 1.);
		glEnable(GL_LIGHT0);
		glDisable(GL_LIGHTING);
		glColor3f(1., 1., 1.);
		glPushMatrix();
			glTranslatef(-100, 100, 0.000);
			glutSolidSphere(5.5, 10, 10);
		glPopMatrix();
		glEnable(GL_LIGHTING);
	glPopMatrix();
	*/

	//Point Light in car to Light the car
	glEnable(GL_LIGHTING);
	glPushMatrix();
		SetPointLight(GL_LIGHT0, -100., 50.0, 0.0, 1., 1., 1.);
		glEnable(GL_LIGHT0);
	glPopMatrix();
	...
	glPushMatrix();
		glPushMatrix();
			glTranslatef(0., -9., 0.);
			glScalef(6., 6., 6.);
			SetMaterial(83. / 255, 92. / 255, 96. / 255, 16.f);
			glCallList(road);
		glPopMatrix();
		...
		glPushMatrix();
			glRotatef(90, 0., 1., 0.);
			glTranslatef(-23.00, 0., 23.500);
			SetMaterial(92. / 255, 64. / 255, 51. / 255, 16.f);
			glCallList(wall);
		glPopMatrix();

		glEnable(GL_LIGHTING);
		glTranslatef((100 * Time) -90., 0., 0.0);
		
		//Head Light 1
		SetSpotLight(GL_LIGHT1, 8.050, 0.2, -2.300, 1, 0., 0., 1., 1., 1.);
		glEnable(GL_LIGHT1);
		glDisable(GL_LIGHTING);
		glColor3f(1., 1., 1.);
		glPushMatrix();
			glTranslatef(8.050, 0.2, 2.300);
			glutSolidSphere(0.2, 10, 10);
		glPopMatrix();
		
		//Head Light 2
		SetSpotLight(GL_LIGHT2, 8.450, 0.2, -2.500, 1, 0., 0., 1., 1., 1.);
		glEnable(GL_LIGHT2);
		glDisable(GL_LIGHTING);
		glColor3f(1., 1., 1.);
		glPushMatrix();
			glTranslatef(8.450, 0.2, -2.300);
			glutSolidSphere(0.2, 10, 10);
		glPopMatrix();

		//Car Obj file
		glEnable(GL_LIGHTING);
		SetMaterial(1.f, 0.f, 0.f, 16.f);
...
InitLists( )
{
	...
	glNewList(wall, GL_COMPILE);
		LoadObjFile("Brick_wall.obj");
	glEndList();

	road = glGenLists(1);
	glNewList(road, GL_COMPILE);
		LoadObjFile("beam-bridge.obj");
	glEndList();
